...
urlpatterns = [
  ...
  path("catalogue/<str:category_pk>/<int:commodity_pk>/", views.commodity, name="commodity"),
  path("catalogue/<str:category_pk>/<int:commodity_pk>/comment/", views.comment, name="comment"),
